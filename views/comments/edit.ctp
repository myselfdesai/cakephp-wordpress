...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action' => 'delete', $form->value('Comment.comment_ID')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('Comment.comment_ID'))); ?></li>
