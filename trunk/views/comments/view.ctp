...
<h2><?php  __('Comment');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Comment Parent'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
...
<div class="related">
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				<?php echo $html->link(__('View', true), array('controller' => 'commentmeta', 'action' => 'view', $commentmetum['id'])); ?>
				<?php echo $html->link(__('Edit', true), array('controller' => 'commentmeta', 'action' => 'edit', $commentmetum['id'])); ?>
				<?php echo $html->link(__('Delete', true), array('controller' => 'commentmeta', 'action' => 'delete', $commentmetum['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $commentmetum['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
